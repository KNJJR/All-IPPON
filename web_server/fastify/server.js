...
fastify.register(require('@fastify/static'), {
  ...
  fastify.register(proxy, {
    upstream: 'http://webmeeting:8080',
    prefix: "/chime-integration/create-meeting", // optional
    rewritePrefix: "/chime-integration/create-meeting", // optional
    http2: false // optional
  })

  fastify.register(proxy, {
    upstream: 'http://webmeeting:8080',
    prefix: "/chime-integration/meeting-session", // optional
    rewritePrefix: "/chime-integration/meeting-session", // optional
    http2: false // optional
  })

  fastify.register(proxy, {
    upstream: 'http://webmeeting:8080',
    prefix: "/chime-integration/messaging-session/:meetingId", // optional
    rewritePrefix: "/chime-integration/messaging-session/:meetingId", // optional
    http2: false // optional
  })

  fastify.register(proxy, {
    upstream: 'http://webmeeting:8080',
    prefix: "/chime-integration/message", // optional
    rewritePrefix: "/chime-integration/message", // optional
    http2: false // optional
  })
...
//   });
  ...
  //       let message = await axios.get("http://webmeeting:8080/test2",{});
  //       return message;
  //   }
  // );
